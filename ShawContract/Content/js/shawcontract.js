(function() {
  ...
  function captureBoardDropDownClick() {
    var boardDropDownContent = document.getElementById("boardDropDownContent");
    var shareThisBoardBtn = document.getElementById("shareThisBoard");
    var createNewBoardBtn = document.getElementById("createNewBoardBtn");
    if (!boardDropDownContent) {
      return;
    }

    boardDropDownContent.addEventListener("click", function(event) {
      var target = event.target;
      if (
        target !== shareThisBoardBtn &&
        target !== createNewBoardBtn
        ) {
