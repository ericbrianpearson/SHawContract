...
[assembly: RegisterDocumentType(Resilient.CLASS_NAME, typeof(Resilient))]

namespace CMS.DocumentEngine.Types.ShawContract
{
	/// <summary>
	/// Represents a content item of type Resilient.
	/// </summary>
	public partial class Resilient : SKUTreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "ShawContract.Resilient";


		/// <summary>
		/// The instance of the class that provides extended API for working with Resilient fields.
		/// </summary>
		private readonly ResilientFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int ResilientID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("ResilientID"), 0);
			}
			set
			{
				SetValue("ResilientID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with Resilient fields.
		/// </summary>
		[RegisterProperty]
		public ResilientFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with Resilient fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class ResilientFields : AbstractHierarchicalObject<ResilientFields>
		{
			/// <summary>
			/// The content item of type Resilient that is a target of the extended API.
			/// </summary>
			private readonly Resilient mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="ResilientFields" /> class with the specified content item of type Resilient.
			/// </summary>
			/// <param name="instance">The content item of type Resilient that is a target of the extended API.</param>
			public ResilientFields(Resilient instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.ResilientID;
				}
				set
				{
					mInstance.ResilientID = value;
				}
			}
		...
		{
		    /// <summary>
			/// The content item of type <see cref="Resilient" /> that is a target of the extended API.
			/// </summary>
			private readonly Resilient mInstance;
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="ProductFields" /> class with SKU related fields of type <see cref="Resilient" /> .
			/// </summary>
			/// <param name="instance">The content item of type Resilient that is a target of the extended API.</param>
			public ProductFields(Resilient instance)
			{
				mInstance = instance;
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Resilient" /> class.
		/// </summary>
		public Resilient() : base(CLASS_NAME)
		{
			mFields = new ResilientFields(this);
