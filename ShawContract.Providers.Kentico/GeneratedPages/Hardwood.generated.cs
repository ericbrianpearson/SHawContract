...
[assembly: RegisterDocumentType(Hardwood.CLASS_NAME, typeof(Hardwood))]

namespace CMS.DocumentEngine.Types.ShawContract
{
	/// <summary>
	/// Represents a content item of type Hardwood.
	/// </summary>
	public partial class Hardwood : SKUTreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "ShawContract.Hardwood";


		/// <summary>
		/// The instance of the class that provides extended API for working with Hardwood fields.
		/// </summary>
		private readonly HardwoodFields mFields;
		...
		/// </summary>
		[DatabaseIDField]
		public int HardwoodID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("HardwoodID"), 0);
			}
			set
			{
				SetValue("HardwoodID", value);
			}
		}
		...
		public string Species
		{
			get
			{
				return ValidationHelper.GetString(GetValue("Species"), @"");
			}
			set
			{
		...
		public string EdgeProfile
		{
			get
			{
				return ValidationHelper.GetString(GetValue("EdgeProfile"), @"");
			}
			set
			{
				SetValue("EdgeProfile", value);
			}
		}
		...
		public string Finish
		{
			get
			{
				return ValidationHelper.GetString(GetValue("Finish"), @"");
			}
			set
			{
		...
		/// </summary>
		[DatabaseField]
		public string OverallThickness
		{
			get
			{
				return ValidationHelper.GetString(GetValue("OverallThickness"), @"");
			}
			set
			{
				SetValue("OverallThickness", value);
			}
		}
		...
		public string Installation
		{
			get
			{
				return ValidationHelper.GetString(GetValue("Installation"), @"");
			}
			set
			{
				SetValue("Installation", value);
			}
		}
		...
		public string SimilarProducts
		{
			get
			{
				return ValidationHelper.GetString(GetValue("SimilarProducts"), @"");
			}
			set
			{
				SetValue("SimilarProducts", value);
			}
		}
		...
		public string FeatureImage
		{
			get
			{
				return ValidationHelper.GetString(GetValue("FeatureImage"), @"");
			}
			set
			{
				SetValue("FeatureImage", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with Hardwood fields.
		/// </summary>
		[RegisterProperty]
		public HardwoodFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with Hardwood fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class HardwoodFields : AbstractHierarchicalObject<HardwoodFields>
		{
			/// <summary>
			/// The content item of type Hardwood that is a target of the extended API.
			/// </summary>
			private readonly Hardwood mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="HardwoodFields" /> class with the specified content item of type Hardwood.
			/// </summary>
			/// <param name="instance">The content item of type Hardwood that is a target of the extended API.</param>
			public HardwoodFields(Hardwood instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.HardwoodID;
				}
				set
				{
					mInstance.HardwoodID = value;
				}
			}
			...
			public string Species
			{
				get
				{
					return mInstance.Species;
				}
				set
				{
					mInstance.Species = value;
				}
			}
			...
			public string EdgeProfile
			{
				get
				{
					return mInstance.EdgeProfile;
				}
				set
				{
					mInstance.EdgeProfile = value;
				}
			}
			...
			public string Finish
			{
				get
				{
					return mInstance.Finish;
				}
				set
				{
					mInstance.Finish = value;
				}
			}
			...
			public string OverallThickness
			{
				get
				{
					return mInstance.OverallThickness;
				}
				set
				{
					mInstance.OverallThickness = value;
				}
			}
			...
			public string Installation
			{
				get
				{
					return mInstance.Installation;
				}
				set
				{
					mInstance.Installation = value;
				}
			}
			...
			public string SimilarProducts
			{
				get
				{
					return mInstance.SimilarProducts;
				}
				set
				{
					mInstance.SimilarProducts = value;
				}
			}
			...
			public string FeatureImage
			{
				get
				{
					return mInstance.FeatureImage;
				}
				set
				{
					mInstance.FeatureImage = value;
				}
			}
		...
		{
		    /// <summary>
			/// The content item of type <see cref="Hardwood" /> that is a target of the extended API.
			/// </summary>
			private readonly Hardwood mInstance;
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="ProductFields" /> class with SKU related fields of type <see cref="Hardwood" /> .
			/// </summary>
			/// <param name="instance">The content item of type Hardwood that is a target of the extended API.</param>
			public ProductFields(Hardwood instance)
			{
				mInstance = instance;
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Hardwood" /> class.
		/// </summary>
		public Hardwood() : base(CLASS_NAME)
		{
			mFields = new HardwoodFields(this);
