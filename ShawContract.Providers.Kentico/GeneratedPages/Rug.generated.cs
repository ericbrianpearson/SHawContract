...
[assembly: RegisterDocumentType(Rug.CLASS_NAME, typeof(Rug))]

namespace CMS.DocumentEngine.Types.ShawContract
{
	/// <summary>
	/// Represents a content item of type Rug.
	/// </summary>
	public partial class Rug : SKUTreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "ShawContract.Rug";


		/// <summary>
		/// The instance of the class that provides extended API for working with Rug fields.
		/// </summary>
		private readonly RugFields mFields;
		...
		public int RugID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("RugID"), 0);
			}
			set
			{
				SetValue("RugID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with Rug fields.
		/// </summary>
		[RegisterProperty]
		public RugFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with Rug fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class RugFields : AbstractHierarchicalObject<RugFields>
		{
			/// <summary>
			/// The content item of type Rug that is a target of the extended API.
			/// </summary>
			private readonly Rug mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="RugFields" /> class with the specified content item of type Rug.
			/// </summary>
			/// <param name="instance">The content item of type Rug that is a target of the extended API.</param>
			public RugFields(Rug instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.RugID;
				}
				set
				{
					mInstance.RugID = value;
				}
			}
		...
		{
		    /// <summary>
			/// The content item of type <see cref="Rug" /> that is a target of the extended API.
			/// </summary>
			private readonly Rug mInstance;
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="ProductFields" /> class with SKU related fields of type <see cref="Rug" /> .
			/// </summary>
			/// <param name="instance">The content item of type Rug that is a target of the extended API.</param>
			public ProductFields(Rug instance)
			{
				mInstance = instance;
			}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Rug" /> class.
		/// </summary>
		public Rug() : base(CLASS_NAME)
		{
			mFields = new RugFields(this);
